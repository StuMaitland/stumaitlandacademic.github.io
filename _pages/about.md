...
I've also developed an interest in [natural language processing](https://doi.org/10.1136/pmj-2022-142080), large language models and their potential applications in healthcare, particularly in improving clinical decision-making and patient outcomes. I've shown how [ChatGPT can pass the MRCP written examinations](https://doi.org/10.1136/bmjopen-2023-080558), and yet make fundamental, catastrophic errors, and discussed [ethics and biases of AI in healthcare](https://doi.org/10.1136/bmjinnov-2019-000376).
